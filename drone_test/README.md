...
1.  Bu repoyu catkin çalışma alanınızın `src` klasörüne klonlayın veya dosyaları kopyalayın.
    ```bash
    cd ~/catkin_ws/src
...
3.  Python dosyalarına çalıştırma izni verin:
    ```bash
